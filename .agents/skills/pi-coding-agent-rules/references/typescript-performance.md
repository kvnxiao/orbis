...
startup time, tool latency, terminal responsiveness, heap growth, or context size. Investigate
repeated I/O, serialization, full-history scans, and retained objects before micro-optimizing
syntax.
