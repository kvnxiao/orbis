...
The initial host contract targets the npm installation of Pi 0.85.1 and Node.js 22.19.0 or later
...
| REQ-active-theme          | Preview a theme with supplied colors, close, and reopen: the host's active theme and persisted setting are unchanged. Inspect fixtures against Pi 0.85.1 token/background use.                                                                                                                                                                                                       |
